...
function otpEmail(code, ttlMinutes) {
  const subject = 'Your Nutro verification code';
  const text = `Your Nutro verification code is ${code}. It expires in ${ttlMinutes} minutes.`;
  const html = `
  <div style="font-family:-apple-system,Segoe UI,Roboto,Arial,sans-serif;max-width:440px;margin:0 auto;padding:24px;color:#0f172a">
    <div style="text-align:center;margin-bottom:16px">
      <div style="display:inline-block;background:#1B6FC4;color:#fff;font-weight:800;font-size:18px;border-radius:14px;padding:10px 16px">Nutro</div>
    </div>
    <h2 style="font-size:18px;margin:0 0 8px">Verify your email</h2>
    <p style="font-size:14px;color:#475569;margin:0 0 20px">Use this code to finish creating your Nutro account. It expires in ${ttlMinutes} minutes.</p>
